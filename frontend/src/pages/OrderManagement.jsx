...
const initialOrders = [
    {
        ...
        orderStatus: "Pending", // Change initial status to Pending
    ...
    },
    {
        ...
        confirmed: true, // Change initial confirmation status
        date: "2024-10-02",
...
function OrderManagement() {
    ...
    const handleConfirmOrder = (index) => {
        let updatedOrders = [...orders];
        updatedOrders[index].confirmed = true; // Confirm the order
        updatedOrders[index].orderStatus = 'Confirmed'; // Change order status to Confirmed
        setOrders(updatedOrders);
    };
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button
                                                                ...
                                                                disabled={!order.confirmed || order.orderStatus === 'Dispatched'}
                                                            >
